...
| 版本类型          | 适用场景                          | 状态 |
|-------------------|----------------------------------|------|
| 💻 **桌面GUI版**   | 本地使用，图形界面操作           | 主分支 (main) |
| 🌐 **Web版**       | Docker部署，远程访问，多用户     | [dockerweb分支](https://github.com/ksbbs/AI_NovelGenerator/tree/dockerweb) |

> 🌐 **Web版部署指南**: 查看 [DEPLOYMENT.md](./DEPLOYMENT.md)
